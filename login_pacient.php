...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT id_pacient, username, password FROM pacienti WHERE username = ?";
...
<br>
    ...
    <div class="wrapper">
        ...
        <form id="forms" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Nu aveti cont de autentificare? <a href="register_pacient.php">Inregistarti-va aici</a>.</p>
        </form>

        <br>
        <h2>Autentificare medic</h2>
        <a href="login_medic.php" class=" button2 btn btn-danger ml-3">Autentificare medic</a>
