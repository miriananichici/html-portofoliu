...
$pacient_cautat=$_POST['pacient_cautat'];
...
<div class="container-fluid">
  <div class="row content">
    ...
    <form class="form-inline" action="cauta.php" method="post">
...
$query=mysqli_query($con, "SELECT  A.nume, A.prenume, A.adresa, A.telefon, A.sex FROM pacienti A, bookings B WHERE A.id_pacient=B.id_pacient AND B.id_medic='$id[0]' AND B.name_pacient LIKE '$pacient_cautat'");
if (!$query) {
    die('Pacientul nu a fost gasit: ' );
}
