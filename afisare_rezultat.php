            ...
            <div class="col-sm-9">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <label>Nnume: </label>
                        <input type="text" class="form-control" name="nume2_form" disabled value="<?php echo  $nume_pacient; ?>">
                    </div>


                    <div class="form-group">
                        <label>Prenume: </label>
                        <input type="text" class="form-control" name="prenume2_form" disabled value="<?php echo $prenume_pacient; ?>">
                    </div>


                    <div class="form-group">
                        <label>Sex</label>
                        <input type="text" class="form-control" name="nume2_form" disabled value="<?php echo $sex_pacient; ?>">

                    </div>

                    <div class="form-group">
                        <label>Data nastere</label>
                        <input type="text" class="form-control" name="nume2_form" disabled value="<?php echo $data_nastere_pacient; ?>">

                    </div>
                    <div class="form-group">
                        <label>Varsta </label>
                        <input type="text" class="form-control" name="nume2_form" disabled value="<?php echo $varsta_pacient; ?> ani">

                    </div>

                    <div class="form-group">
                        <label>Telefon: </label>
                        <input type="text" class="form-control" name="nume2_form" disabled value="<?php echo $telefon_pacient; ?>">
                    </div>

                    <div class="form-group">
                        <label>Adresa: </label>
                        <input type="text" class="form-control" name="nume2_form" disabled value="<?php echo $adresa_pacient; ?>">
                    </div>
