                ...
                <table class="table">
                    <tbody>
                      ...
                      //  $today = $date == date('Y-m-d') ? "today" : "";
                        $query = mysqli_query($con, "SELECT   B.id_programare, B.date, B.timeslot, A.nume, A.prenume, A.telefon, A.sex,a.varsta FROM pacienti A, bookings B WHERE A.id_pacient=B.id_pacient AND B.id_medic='$id[0]' ORDER BY B.date desc ");
                        if (!$query) {
                            die('Invalid query: ');
                        }
                        ...
                        while ($row = mysqli_fetch_row($query)) {
                            ...
                            echo "<td>" .
                                "<a class='btn btn-primary btn-sm' href='adaugare_rezultat.php?id_programare=$id_programare&nume_pacient1=$nume_pacient&prenume_pacient1=$prenume_pacient'>Adauga rezultat</a>&nbsp;&nbsp;" .
                                
                                "<a class='btn btn-primary btn-sm' href='afisare_rezultat.php?id_programare=$id_programare&nume_pacient1=$nume_pacient&prenume_pacient1=$prenume_pacient'>Afisare rezultat</a>" .
                                "</td>";
