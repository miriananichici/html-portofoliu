    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
        <div class="container">
            ...
            <a class="navbar-brand" href="#">
                <img src="https://www.clinica360.ro/wp-content/uploads/2019/10/cardio-1.png" alt="logo" style="width:60px;">
            </a>

            <!-- Links -->
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="http://127.0.0.1:5501/Pagina%20de%20pornire.html">Home</a>
                </li>
                <li class="nav-item">
